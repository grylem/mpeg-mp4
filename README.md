# **MPEG-MP4** media file format bitstream processing library
...
3. Check out the output
    ...
    |  |  |      uint32     track_ID            : 1
    |  |  |      uint32     reserved            : 0
    |  |  |      uint64     duration            : 2138893713408000
    |  |  |      uint32[2]  reserved            : [0, 0]
    |  |  |      int16      layer               : 0
    ...
    |  |  |      uint16     reserved            : 0
    |  |  |      int32[9]   matrix              : [65536, 0, 0, 0, 65536, 0, 0, 0, 1073741824]
    |  |  |      uint32     width               : 36700160
    |  |  |      uint32     height              : 20971520
    |  |  |  }
    ...
    |  |  |  |  |  |  |      uint16     width               : 560
    |  |  |  |  |  |  |      uint16     height              : 320
    |  |  |  |  |  |  |      uint32     horizresolution     : 4718592
    |  |  |  |  |  |  |      uint32     vertresolution      : 4718592
    |  |  |  |  |  |  |      uint32     reserved            : 0
    ...
    |  |  |  |  |  |  |  }
    |  |  |  |  |  |  +- Entry #5 { // [4 bytes] @381380
    |  |  |  |  |  |  |      uint32     chunk_offset        : 51365
    |  |  |  |  |  |  |  }
    |  |  |  |  |  |  |
    |  |  |  |  |  |  | ...
    |  |  |  |  |  |  |
    ...
    |  |  |  |  |  |  | ...
    |  |  |  |  |  |  |
    |  |  |  |  |  |  +- Entry #18 { // [8 bytes] @381704
    |  |  |  |  |  |  |      uint2      is_leading          : 1
    |  |  |  |  |  |  |      uint2      sample_depends_on   : 0
    |  |  |  |  |  |  |      uint2      sample_is_depended_on: 1
    |  |  |  |  |  |  |      uint2      sample_has_redundancy: 0
    |  |  |  |  |  |  |  }
    |  |  |  |  |  |  +- Entry #19 { // [8 bytes] @381712
    |  |  |  |  |  |  |      uint2      is_leading          : 1
    |  |  |  |  |  |  |      uint2      sample_depends_on   : 0
    |  |  |  |  |  |  |      uint2      sample_is_depended_on: 1
    |  |  |  |  |  |  |      uint2      sample_has_redundancy: 0
    ...
    |  |  |      uint32     track_ID            : 2
    |  |  |      uint32     reserved            : 0
    |  |  |      uint64     duration            : 2152294011371520
    |  |  |      uint32[2]  reserved            : [0, 0]
    |  |  |      int16      layer               : 0
    |  |  |      int16      alternate_group     : 0
    |  |  |      int16      volume              : 256
